...
export const SchedulePayloadSchema = z.object({ jobs: z.array(ScheduleJobSchema), scannedAt: z.string().optional(), writable: z.boolean() });
...
export const ScheduleMutationResponseSchema = ApiNoticeSchema.extend({ job: ScheduleJobSchema, jobs: z.array(ScheduleJobSchema), writable: z.boolean() });
