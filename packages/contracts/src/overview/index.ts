...
export const OverviewNodeSchema = z.object({
  id: z.string(), name: z.string(), ip: z.string(), env: z.string(), status: z.enum(["健康", "警告", "维护"]),
...
export const OverviewSummaryPayloadSchema = z.object({
  ...
  risks: z.array(OverviewRiskRecordSchema), resources: z.record(z.string(), z.array(OverviewResourceRecordSchema)), lastRefresh: z.string(),
});
export const OverviewHealthPayloadSchema = z.object({ nodes: z.array(OverviewNodeSchema), lastRefresh: z.string() });
