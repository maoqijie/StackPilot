...
StackPilot `0.2.0-preview.3` is a preview release, not a stable production release. Support below means the release gates are designed for that target; it does not imply an SLA.
...
| Controller | `0.2.0-preview.3` | must match Web release version |
