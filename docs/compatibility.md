...
| Controller state | embedded SQLite, schema `9` | direct upgrade from schemas 1 through 8; rollback to a schema 8 Controller requires the verified pre-upgrade backup |
