...
| Database | embedded SQLite, schema `6` | direct upgrade from schemas 1 through 5; restore accepts schemas 1 through 6 |
...
| `0.2.x` | any | `1.x` | 1 through 5 | upgrade required; back up before migration |
