...
Current version: `0.3.0-preview.10`. StackPilot uses Semantic Versioning, but this is preview software and not a stable production release. `0.x` minor releases may contain breaking changes; prerelease labels do not carry a support SLA.
