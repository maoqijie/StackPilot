...
Status: protocol design for StackPilot `0.2.0-preview.2`. This document is normative for the initial Controller-Agent implementation. The feature remains preview quality and is not a stable release.
