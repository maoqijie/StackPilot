...
sudo deploy/scripts/install-systemd.sh cert-helper # Linux Nginx/Certbot site operations
```
...
sudo systemctl enable --now stackpilot-cert-helper.socket # managed site hosts only
