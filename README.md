...
> **项目成熟度：预览版。** 当前版本为 `0.3.0-preview.3`，提供可重复的部署、迁移、回滚和发布验证流程，但尚未达到稳定生产发布条件，也不提供 SLA。正式支持范围和已验证边界见[兼容性矩阵](docs/compatibility.md)。
...
npm run release:verify -- output/release/0.3.0-preview.3/SHA256SUMS
