...
export const updateIdentityRole=(id:string,payload:{id:string;name:string;description:string;permissions:Permission[]},proof:string)=>requestJson<{message:string}>(`/roles/${encodeURIComponent(id)}`,{method:"PATCH",headers:{"X-Reauth-Proof":proof},body:JSON.stringify(payload)});
