...
describe("database audit context", () => {
  beforeEach(() => {
    ...
    vi.mocked(fetchAuditEvents).mockReset().mockResolvedValue([
      { eventId: "database-event", occurredAt: "2026-07-14T00:00:00.000Z", actorType: "user", actorId: "operator", source: "database-controller", targetType: "database-operation", targetId: "operation-1", action: "database.operation.queued", parameters: "{}", outcome: "queued", requestId: "request-1", traceId: "trace-1" },
      { eventId: "other-event", occurredAt: "2026-07-14T00:00:00.000Z", actorType: "user", actorId: "operator", source: "controller", targetType: "file", targetId: "/tmp/a", action: "file.trash", parameters: "{}", outcome: "success", requestId: "request-2", traceId: "trace-2" },
    ]);
  });
