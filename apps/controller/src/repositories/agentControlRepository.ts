...
import type { AgentCapability, AgentHeartbeat, AgentNodeRecord, AgentSiteSnapshot, AgentTelemetrySnapshot, RemoteTaskRecord } from "@stackpilot/contracts";
import { AgentHealthSchema, AgentNodeRecordSchema, AgentSiteSnapshotSchema, AgentTelemetrySnapshotSchema, RemoteTaskRecordSchema } from "@stackpilot/contracts";
import { z } from "zod";
...
export type AgentNodeState = AgentNodeRecord & { telemetry?: AgentTelemetrySnapshot; siteSnapshot?: AgentSiteSnapshot; heartbeatHealthStatus?: AgentHeartbeat["health"]["status"] };
...
export const DEFAULT_AGENT_CAPABILITIES: readonly AgentCapability[] = ["system.summary.read", "service.status.read", "sites.inventory.read"];
