...
export class OverviewService {
  ...
  private aggregateResources(snapshot: PlatformSnapshot, telemetry: AgentTelemetrySnapshot[]): ResourceAggregate {
    ...
    return { cpuSamples, cpu, memoryTotal, memoryUsed, memory: percent(memoryUsed, memoryTotal), diskTotal, diskUsed, disk: percent(diskUsed, diskTotal), diskVolumes: volumes.length, loadAverages, liveNodes: loads.length };
  }
