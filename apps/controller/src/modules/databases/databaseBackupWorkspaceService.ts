import { BusinessDatabaseBackupsPayloadSchema, type CreateBusinessDatabaseBackupPlanRequest, type NodeScope, type UpdateBusinessDatabaseBackupPlanRequest } from "@stackpilot/contracts";
