...
export type Services = { overview: OverviewService; hosts: HostMonitoringService; sites: SiteMonitoringService; fileTrash: FileTrashService; risks: RiskService; schedules: ScheduleService; tasks: TaskService; enrollments: EnrollmentService; nodes: NodeService; remoteTasks: RemoteTaskService };
