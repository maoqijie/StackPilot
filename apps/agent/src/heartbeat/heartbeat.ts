...
export function createHeartbeat(config: AgentConfig, nodeId: string, capabilities: AgentHeartbeat["capabilities"], telemetry?: AgentTelemetrySnapshot, telemetryCollectionFailed = false, siteSnapshot?: AgentSiteSnapshot, databaseSnapshot?: AgentDatabaseSnapshot): AgentHeartbeat {
  let uptimeSeconds = 0;
